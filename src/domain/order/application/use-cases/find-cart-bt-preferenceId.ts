...
export class FindCartByPreferenceIdUseCase {
    ...
    async savePreferenceId(cartId: string, preferenceId: string): Promise<Either<Error, void>> {
    ...
    async saveCollectionId(cartId: string, collection_id: string, merchant_order_id: string): Promise<Either<Error, void>> {
