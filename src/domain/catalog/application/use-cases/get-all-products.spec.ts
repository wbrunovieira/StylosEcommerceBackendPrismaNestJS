...
describe("GetAllProductsUseCase", () => {
    ...
    //     } else {
    //         throw new Error("Expected to retrieve an empty array");
    //     }
    // });
    ...
    //         return Promise.resolve(left(new ResourceNotFoundError("No products found")));
    //     });
    ...
    //     } else {
    //         throw new Error("Expected ResourceNotFoundError but got a successful result");
    //     }
    // });
});
